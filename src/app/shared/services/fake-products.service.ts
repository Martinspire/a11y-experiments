...
export class FakeProductsService {
  ...
  getProductsWithOrdersData(): FakeProduct[] {
    return [
      {
        id: '1000',
        code: 'f230fh0g3',
  ...
  getProductsMini() {
    const miniLimit = 5;
    return of(this.getProductsData().slice(0, miniLimit));
  }

  getProductsSmall() {
    const smallLimit = 10;
    return of(this.getProductsData().slice(0, smallLimit));
  }
  ...
  getProductsWithOrdersSmall() {
    const smallLimit = 10;
    return of(this.getProductsWithOrdersData().slice(0, smallLimit));
  }

  getProductsWithOrders() {
    return of(this.getProductsWithOrdersData());
  }
}
